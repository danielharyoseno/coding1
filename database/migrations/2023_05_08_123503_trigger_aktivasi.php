...
return new class extends Migration
{
    ...
    {
        DB::unprepared("
        CREATE TRIGGER `increment_no_struk_aktivasi` BEFORE INSERT ON `transaksi_aktivasis` FOR EACH ROW 
            BEGIN 
            DECLARE last_id INT; 
            ...
            END IF; 
            SET NEW.no_struk_aktivasi = new_id; 
            END
        ");
    }
    ...
    {
        DB::unprepared('DROP TRIGGER `increment_no_struk_aktivasi`');
    }
};